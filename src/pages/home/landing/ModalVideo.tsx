...
export default function ModalVideo({
  ...
  return (
    <div className="relative">
      <div
        className="pointer-events-none absolute bottom-8 left-1/2 z-0 -ml-28 -translate-x-1/2 translate-y-1/2"
        aria-hidden="true"
      >
        <img
      ...
      >
        ...
        <div className="fixed inset-0 z-[99999] flex px-4 py-6 sm:px-6">
          <div className="mx-auto flex h-full max-w-6xl items-center">
            <DialogPanel className="aspect-video max-h-full w-full overflow-hidden rounded-2xl bg-black shadow-2xl duration-300 ease-out">
              <video
                ref={videoRef}
                width={videoWidth}
                height={videoHeight}
